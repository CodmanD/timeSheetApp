...
*/
        ...
        //Setting listener for change date
...
//Getting data from  User Calendar for a certain date
            ...
            if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                ...
                if (mCursor.moveToFirst())
                    do {
                        ...
                        if (acc.equals(accountName) && title.equals(accountName))
                            ids.add(id);
    ...
    //Reading data from Data Base and saving in list
   ...
   // left-to-right handler
    ...
    //Readin coordinates from Data Base
    ...
    //Creating list with current Activities
